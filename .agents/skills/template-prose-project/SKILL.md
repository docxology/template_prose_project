...
uv run python scripts/pipeline/stage_02_analysis.py --project templates/template_prose_project
uv run python scripts/pipeline/stage_03_render.py --project templates/template_prose_project
